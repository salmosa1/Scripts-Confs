...
Camba PRO
C:\Program Files (x86)\Microsoft Dynamics NAV\110\RoleTailored Client\finsql.exe Command=generatesymbolreference,Database=ST-105283,ServerName=DTCSQLWE05-02

Encamina
C:\Program Files (x86)\Microsoft Dynamics 365 Business Central\140\RoleTailored Client\finsql.exe Command=generatesymbolreference,Database=ENCAMINA_BC_DEV,ServerName=NAV
 
C:\Program Files (x86)\Microsoft Dynamics 365 Business Central\140\RoleTailored Client\finsql.exe Command=generatesymbolreference,Database=ST-125067,ServerName=dtcsqlwe14-02